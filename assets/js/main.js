...
<div class="nav-wrapper">
    <a href="#!" class="brand-logo"><img src="assets/images/name.png"></a>
...
<div class="social-icons-footer mx-lg-auto">
  <a class="social-icon-footer twitter" href="https://twitter.com/azamptotic" target="_blank" rel="author">
    <i class="fab fa-twitter"></i>
      </a>
  <a class="social-icon-footer instagram" href="https://www.instagram.com/aazam_jutt/" target="_blank" rel="author">
    <i class="fab fa-instagram"></i>
      </a>
  <a class="social-icon-footer linkedin" href="https://www.linkedin.com/in/muhammad-azam-349bab1a9/" target="_blank" rel="author">
    <i class="fab fa-linkedin-in"></i>
      </a>
  <a class="social-icon-footer dev" href="https://dev.to/aazamjutt" target="_blank" rel="author">
    <i class="fab fa-dev"></i>
      </a>
  <a class="social-icon-footer github" href="https://github.com/AazamJutt" target="_blank" rel="author">
    <i class="fab fa-github"></i>
      ...
      <div class="contact-form">
          <form action="mailto:m.aazasultan@gmail.com" method="post" enctype="text/plain">
